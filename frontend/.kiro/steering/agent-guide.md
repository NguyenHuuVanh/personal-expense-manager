...
Nên tách thành các spec nhỏ:
- Filter orders theo date range
- Order detail drawer
- Fix double-submit ở checkout

### 2. Dùng từ khóa mức độ bắt buộc
...
- **Goal**: Feature giải quyết vấn đề gì?
- **Non-goals**: Những gì chủ động không làm
- **Constraints**: Design system, API, routing...
- **Invariants**: Những thứ không được phá vỡ

### 4. Viết spec theo user scenario, không viết theo component tree

### 5. Mọi màn hình quan trọng phải có state matrix

- Initial, Loading, Success, Empty, Error, Disabled, Submitting, Offline
...
- Layout thay đổi ra sao

### 8. Accessibility là bắt buộc

- ARIA labels, keyboard nav
- Focus visible
- Screen reader support
- Contrast tối thiểu (WCAG 2.1 AA)
...
## Cấu trúc chuẩn của một spec frontend (16 phần)
...
## Quy tắc cho AI khi implement

1. Hỏi clarify nếu yêu cầu còn mơ hồ
2. Tuân theo cấu trúc 16 phần
3. Dùng từ khóa MUST/SHOULD/MAY
4. Bao gồm state matrix
5. Bao gồm data contract
6. Liệt kê acceptance criteria đo được